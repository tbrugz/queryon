...
var SqlHighlightRules = function() {
    ...
    var keywords = (
        ...
        "foreign|not|references|default|null|inner|cross|natural|database|drop|grant"
            + "|set|distinct|with|between|like|is|into|values|alter|constraint|unique|in"
            + "|all|exists|full|partition|any|some|using|alias|aggregate|over|recursive|within"
            + "|replace|function|procedure|package|body|begin|return|for" // plsql keywords
    );

    var builtinConstants = (
        "true|false"
            + "|$where_clause|$filter_clause|$projection_clause|$order_clause|$username" //see: tbrugz.queryon.SQL class
