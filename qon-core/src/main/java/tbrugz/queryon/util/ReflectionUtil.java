...
public class ReflectionUtil {
	...
	public static Object callProtectedMethod(Object o, String methodName, Class<?>[] parameterTypes, Object... args) throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		return callProtectedMethod(clazz, o, methodName, parameterTypes, args);
	}
	
	static Object callProtectedMethod(Class<?> c, Object o, String methodName, Class<?>[] parameterTypes, Object... args) throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		Method m = null;
		for(; m==null && !c.equals(Object.class) ; c = c.getSuperclass()) {
			...
			try {
				...
				if(superc!=null && !superc.equals(Object.class)) {
					return callProtectedMethod(superc, o, methodName, parameterTypes, args);
				}
				*/
				//return null;
			}
